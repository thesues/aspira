...
worker1: ./worker/worker -name ../x -addr 127.0.0.1:3301 -http_addr 0.0.0.0:8081
worker2: ./worker/worker -name ../y -addr 127.0.0.1:3302 -http_addr 0.0.0.0:8082
worker3: ./worker/worker -name ../z -addr 127.0.0.1:3303 -http_addr 0.0.0.0:8083 -cluster 
